        ...
        if (serverId != null && !serverId.isEmpty()) {
            ...
            try {
                if (System.getProperty("dev.mode") != null) {
                    // In development mode, create a mock server to avoid database connection issues
                    currentServer = new com.deadside.bot.db.models.GameServer();
                    currentServer.setGuildId(guildId);
                    currentServer.setServerId(serverId != null ? serverId : "default");
                    currentServer.setName("Development Test Server");
                    isInitialized = true;
                    return;
                }
